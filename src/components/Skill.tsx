  ...
  return (
    <section id="skills" className="min-h-screen px-6 bg-white text-black py-7">
      ...
      <div className="md:ml-12 mb-12">
        <h3 className="text-lg md:text-3xl font-semibold mb-8 ml-2 md:ml-6 text-blue-900 text-left">Technical Skills</h3>
      ...
      <div className="md:ml-12">
        <h3 className="text-lg md:text-2xl font-semibold mb-8 ml-6 text-blue-900">Professional Skills</h3>
